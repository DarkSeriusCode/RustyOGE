...
//! * Структуру или перечисление `ProblemSpec`. Это те самые детали решения задачи, они указывают
//! как именно нужно решить задачу и что требуется вернуть в качастве ответа.
//!
//! ## Примеры
