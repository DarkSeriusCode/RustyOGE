...
const AVAILABLE_PROBLEMS: [u32;10] = [1, 2, 3, 4, 5, 6, 7, 9, 10, 12];
...
fn mix_args_to_solve_if_needed(cmd: Command) -> Command {
    ...
    cmd.mut_subcommand("solve", |subcmd| {
        ...
        match problem_num {
            ...
            4  => module4::Module4InputData::mix_to_command(subcmd),
            ...
            9  => module9::Module9InputData::mix_to_command(subcmd),
